...
fun FoursquareRecentCheckinsResponse.Recent.toDomain(): CheckIn {
  return CheckIn(
    id = id,
...
fun FoursquareRecentCheckinsResponse.Recent.Photos.Item.toDomain(size: String = "original"): Photo {
  return Photo(
    id = id,
...
fun FoursquareRecentCheckinsResponse.Recent.Source.toDomain(): Source {
  return Source(
    name = name,
    url = url,
  )
